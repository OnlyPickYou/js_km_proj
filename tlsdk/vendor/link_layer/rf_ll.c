...
///////////////////////////////////////////////////////////////////////////////
		...
		__PROJECT_DONGLE_ENC_8366__ || __PROJECT_DONGLE_DOUBLE__  )
...
#if(__PROJECT_KEYBOARD__ || __PROJECT_REMINGTON_KEYBOARD__ || __PROJECT_KEYBOARD_ENC_8368__ || __PROJECT_REMINGTON_KEYBOARD_DOUBLE__)
#else
			device_sync = 1;
#endif
...
int	device_send_packet (u8 * p, u32 timeout, int retry, int pairing_link)
{
	...
	for (i=0; i<=retry; i += step) {
		...
		if((paired_info.flag == MOUSE_SEARCH_DONGLE_FLAG)){
