...
enum{
	FLD_RST_MCU = 				BIT(0),
	FLD_RST_ZB =				BIT(1),
	FLD_RST_USB = 				BIT(2), //actually, no USB existing
	FLD_RST_DMA =				BIT(3),
	FLD_RST_ALGM = 				BIT(4),
	FLD_RST_SWR_S =				BIT(5),
	FLD_RST_AIF = 				BIT(6),
	...
	FLD_RST_PWM = 				BIT(11),
	FLD_RST_MSPI = 				BIT(14),
	FLD_RST_BBPLL = 			BIT(15),
	FLD_RST_ADC =				BIT(16),
	FLD_RST_ALGS =				BIT(17),
	FLD_RST_MCIC =				BIT(18),
	FLD_RST_SYSTIMER =			BIT(20),
...
enum{
	...
	FLD_CLK_PWM_EN = 			BIT(3),
	FLD_CLK_AES_EN = 			BIT(5),
	FLD_CLK_SYSTIMER_EN = 		BIT(6),
	FLD_CLK_QDEC_EN = 			BIT(7),
...
/****************************************************
 PWM regs define:  begin  0x780     kevin
 *****************************************************/
#define reg_pwm_enable			REG_ADDR8(0x780)
#define reg_pwm_clk				REG_ADDR8(0x781)
#define reg_pwm_mode			REG_ADDR8(0x782)
