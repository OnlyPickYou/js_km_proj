...
#define reg_adc_ctrl			REG_ADDR16(0x34)
 ...
 *****************************************************/
#define reg_gpio_datai			REG_ADDR32(0x580)
#define reg_gpio_datao			REG_ADDR32(0x584)
#define reg_gpio_oe				REG_ADDR32(0x588)
#define reg_gpio_nrm			REG_ADDR32(0x58c)
...
#define reg_gpio_ie				REG_ADDR32(0x590)
#define reg_gpio_pol			REG_ADDR32(0x594)
#define reg_gpio_ds				REG_ADDR32(0x598)
#define reg_gpio_wakeup_en		REG_ADDR32(0x59c)

enum{
	FLD_GPIO_WAKEUP_SRC24_26 =	BIT_RNG(0,2),
	FLD_GPIO_WAKEUP_EN =		BIT(23),
	FLD_GPIO_IRQ_EN =			BIT(24),
	FLD_GPIO_DM_PULLUP	 =		BIT(25),
	FLD_GPIO_DP_PULLUP	 =		BIT(26),
};

#define reg_gpio_2risc0			REG_ADDR32(0x5a0)
#define reg_gpio_2risc1			REG_ADDR32(0x5a4)
#define reg_gpio_2risc2			REG_ADDR32(0x5a8)
...
#define WATCHDOG_ENABLE			( reg_tmr_ctrl |= FLD_TMR_WD_EN )
...
///////////////////// PM register /////////////////////////
#define		rega_deepsleep_flag		0x2e		//0x2e - 0x33 (watch dog reset)
//#define		rega_deepsleep_flag		0x34		//0x24 - 0x35 (power-on reset)
