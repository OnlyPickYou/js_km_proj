		...
		configuration_desc = { { {
				...
				// debug note: TotalLength must less than  256
					{(sizeof(USB_Audio_Descriptor_Interface_AC_TL_t) + /*10*/
							...
							sizeof(USB_Audio_Descriptor_FeatureUnit_Mic_t)/*10*/), 0}, 2, // InCollection //mz
				...
				{	{	sizeof(USB_Audio_Descriptor_Format_t)
					...
					AUDIO_DSUBTYPE_CSInterface_FormatType, USB_AUDIO_FORMAT_PCM, 1, // Channels
					2, // SubFrameSize
					0x10, // BitsResolution
				...
				{	{
						...
						0x0060, // EndpointSize USB_MIC_CHANNELS_LEN
						1 // PollingIntervalMS
					}, 0, // Refresh
